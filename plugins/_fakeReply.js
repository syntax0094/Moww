...
handler.all = async function (m) {
	...
	//reply link wa
   global.rpl = { contextInfo: { externalAdReply: { mediaUrl: dygp, mediaType: 'VIDEO', description: 'support group', title: packname, body: 'syntax loves you', thumbnailUrl: pp, sourceUrl: dygp }}} 
